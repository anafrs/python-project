...
def play_room(room):
  ...
  inquirer.List('action',
        ...
        if intended_action == "explore":
            ...
            print("Congratulations, everyone finds your moves unintersting, you just made a fool out of yourself")
            play_room(room)
        elif intended_action == "chill" :
            print("You decided to take a break but you remember that you need to go back to your computer to go finnish your Labs, you jump up")
            play_room(room)
        elif intended_action == "look at your labs' backlog" :
            print("You break down and start to cry compulsively, you need to leave this room and go back to work ASAP")
            play_room(room)
        else:
